...
while True:
    ...
    # STEP 4 -Only index finger : Moving mode
        ...
        if fingers[1] == 1 and fingers[2] == 0:#index is up and middle finger is down
    ...
    # STEP 8 -When both index and middle fingers are up: clicking mode
    ...
    # STEP 10 -Click mouse if the distance is short
            if length < 20:
                cv2.circle(img, (lineInfo[4], lineInfo[5]), 15, (0, 255, 0), cv2.FILLED)  # shows a circle when index and
